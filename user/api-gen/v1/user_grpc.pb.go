...
type UserServiceClient interface {
	...
	GetUserByMobile(ctx context.Context, in *GetUserMobileRequest, opts ...grpc.CallOption) (*UserInfo, error)
...
func (c *userServiceClient) GetUserByMobile(ctx context.Context, in *GetUserMobileRequest, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
type UserServiceServer interface {
	...
	GetUserByMobile(context.Context, *GetUserMobileRequest) (*UserInfo, error)
...
func (UnimplementedUserServiceServer) GetUserByMobile(context.Context, *GetUserMobileRequest) (*UserInfo, error) {
...
func _UserService_GetUserByMobile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserByMobile(ctx, req.(*GetUserMobileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
